...
// ============================================================================
// ICONS — lucide-style, hand-rolled, sharp
// ============================================================================
const Icon = ({ d, size = 16, fill = 'none', stroke = 'currentColor', sw = 1.6, children, style }) => (
...
const Icons = {
  ...
  settings: (p) => <Icon {...p}><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2"/><circle cx="12" cy="12" r="3"/></Icon>,
  ...
  report: (p) => <Icon {...p}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></Icon>,
  ...
  trend: (p) => <Icon {...p}><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></Icon>,
  ...
  dollar: (p) => <Icon {...p}><line x1="12" y1="2" x2="12" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></Icon>,
  block: (p) => <Icon {...p}><circle cx="12" cy="12" r="10"/><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"/></Icon>,
  variable: (p) => <Icon {...p}><path d="M4.74 9a8 8 0 0 1 0 6m14.52 0a8 8 0 0 0 0-6"/><path d="M8 12h8"/><path d="M2 12h2"/><path d="M20 12h2"/></Icon>,
  workflow: (p) => <Icon {...p}><rect x="3" y="3" width="6" height="6" rx="1"/><rect x="15" y="15" width="6" height="6" rx="1"/><rect x="9" y="11" width="6" height="6" rx="1"/><path d="M6 9v2a2 2 0 0 0 2 2"/><path d="M18 15v-2a2 2 0 0 0-2-2"/></Icon>,
};

// ============================================================================
// Spark line
// ============================================================================
function Sparkline({ data, color = 'currentColor', width = 64, height = 26 }) {
...
function StatusChip({ status }) {
  const map = {
    ...
    invalid: { label: 'Invalid', cls: 'warning' },
  };
...
function TrackChip({ track }) {
  const labels = { '60_day': '60d', '90_day': '90d', '120_day': '120d' };
  return <span className="track-chip">{labels[track] || track}</span>;
}

function SeqProgress({ current, total = 7 }) {
  return (
    <div className="seq-track" style={{minWidth: 90}}>
      {Array.from({length: total}).map((_, i) => {
        const cls = i < current ? 'done' : (i === current ? 'current' : '');
        return <div key={i} className={`seq-step ${cls}`}></div>;
      })}
    </div>
  );
}

Object.assign(window, { Icons, Sparkline, StatusChip, TrackChip, SeqProgress });
